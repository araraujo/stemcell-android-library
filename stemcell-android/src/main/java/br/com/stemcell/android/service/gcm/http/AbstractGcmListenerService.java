package br.com.stemcell.android.service.gcm.http;
...
import br.com.stemcell.android.R;
...
public abstract class AbstractGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        String showNotification = data.getString("showNotification");
        Log.d(TAG, "From: " + from);
        Log.d(TAG, "Type: " + type);
    ...
    protected abstract void processMessage(String from, Bundle data);
    ...
    private void sendNotification(String title, String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.ic_perm_group_social_info)
