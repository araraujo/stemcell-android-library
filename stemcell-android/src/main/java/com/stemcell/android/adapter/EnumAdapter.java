package com.stemcell.android.adapter;
...
public class EnumAdapter<T> extends BaseAdapter implements SpinnerAdapter {
    ...
    public View getView(int position, View recycle, ViewGroup parent) {
        ...
        if (data.get(position) != null) {
            Method method = ReflectionUtils.findMethod(data.get(position).getClass(), "getDescription");
            description = (String) ReflectionUtils.invokeMethod(method, data.get(position));
        }
